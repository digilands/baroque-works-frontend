...
export default function Signup() {
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-white">
      {/* Left Side: Form */}
      <div className="flex-1 flex justify-center items-center p-6 md:px-12 md:py-6 md:min-h-screen">
        <SignupForm />
      </div>

      {/* Right Side: Marketing/Carousel */}
      <div className="hidden md:flex flex-1 items-center justify-center flex-col bg-gray-50/50 p-10 border-l border-gray-100">
